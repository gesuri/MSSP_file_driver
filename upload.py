...
# 3 args = File name pattern. Only upload files with
...
def upload_file(file_n, folder, content):
    SharePoint().upload_file(file_n, folder, content)
...
# read files and return the content of file
